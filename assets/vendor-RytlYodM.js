...
import { b as requireReact, R as React, r as reactExports } from "./react-B5lGuWoF.js";
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => Promise.resolve().then(() => browserPonyfill$1), true ? [] : void 0).then(function(mod) {
...
function compilePath(path2, caseSensitive = false, end2 = true) {
  warning(
...
export {
  ...
  Transition as F,
  _objectWithoutPropertiesLoose as G,
  createPopper as H,
  CSSTransition as I,
  Backend as J,
  KEYFRAMES as K,
...
//# sourceMappingURL=vendor-RytlYodM.js.map
