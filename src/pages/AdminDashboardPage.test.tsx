...
describe('AdminDashboardPage', () => {
  ...
  it('renders user data after successful fetch and allows state updates via callbacks and displays all sections and titles', async () => {
    ...
    expect(seoEl).toHaveAttribute('data-title', 'seo.title_admin');
    expect(seoEl).toHaveAttribute('data-description', 'seo.description_admin');
    ...
    expect(screen.getByText('dashboard.title_admin')).toBeInTheDocument();
    expect(screen.getByText('dashboard.subtitle_admin')).toBeInTheDocument();
